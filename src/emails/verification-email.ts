                  ...
                  <tr>
                    <td style="padding-top:28px;">
                      <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                          <td style="border-radius:26px; background-color:${COLORS.green};">
                            <a href="${safeUrl}" target="_blank" rel="noopener noreferrer"
                               style="display:inline-block; min-height:48px; line-height:48px; padding:0 32px; font-family:${FONT_STACK}; font-size:15px; font-weight:700; color:${COLORS.buttonText}; text-decoration:none; border-radius:26px;">
                              Verify email
                            </a>
                          </td>
                        </tr>
